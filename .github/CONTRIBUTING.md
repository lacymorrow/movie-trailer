# Contributing to movie-trailer

Thanks for considering a contribution! `movie-trailer` is small, stable, and gets the occasional bug-fix release.

## Setup

```bash
git clone https://github.com/lacymorrow/movie-trailer.git
cd movie-trailer
npm install
```
